...
#' @export
SCDC_prop <- function (bulk.eset, sc.eset, sc.basis, ct.varname, sample, ct.sub, iter.max = 1000,
...
#' @return Estimated proportion, basis matrix, predicted gene expression levels for bulk samples
#' @export
SCDC_prop_ONE <- function (bulk.eset, sc.eset, sc.basis, ct.varname, sample, truep = NULL,
